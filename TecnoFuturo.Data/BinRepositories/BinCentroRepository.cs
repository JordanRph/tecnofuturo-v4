...
namespace TecnoFuturo.Data.BinRepositories
{
        public class BinCentroRepository : ICentroRepository
        {
            ...
            public BinCentroRepository(IServiceProvider serviceProvider)
            {
                ...
                _ruta = Path.Combine(Directory.GetCurrentDirectory(), "centros.bin");
                Cargar();
            }
            ...
            private void Guardar()
            {
                ...
                Serializer.Serialize(stream, _centros.Values);
                }
                catch
                {
            ...
            try
            {
                ...
                var lista = Serializer.Deserialize<List<Centro>>(stream);
